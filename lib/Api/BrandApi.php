...
class BrandApi
{
     ...
     * 
     *
     * @param string $name Optional filter parameter to search for brands with a name that contains value of parameter name. (optional)
     * @param string $description Optional filter parameter to search for brands with description that contains value of parameter description. (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\BrandsArray
     */
    public function allBrands($name = null, $description = null)
    {
        list($response) = $this->allBrandsWithHttpInfo($name, $description);
        return $response;
    }
     ...
     */
    public function allBrandsWithHttpInfo($name = null, $description = null)
    {
        // parse inputs
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BrandsArray', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    /**
     * Operation brandDelete
     *
     * 
     *
     * @param string $id ID for the brand to be deleted. (required)
     * @param string $companyID ID of the Company connected with the Brand (required for Authorization for the User making the request) (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Success
     */
    public function brandDelete($id, $companyID = null)
    {
        list($response) = $this->brandDeleteWithHttpInfo($id, $companyID);
        return $response;
    }

    /**
     * Operation brandDeleteWithHttpInfo
     *
     * 
     *
     * @param string $id ID for the brand to be deleted. (required)
     ...
     */
    public function brandDeleteWithHttpInfo($id, $companyID = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling brandDelete');
        }
        // parse inputs
        $resourcePath = "/brand/{id}/delete";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    public function updateBrandWithHttpInfo($id, $brandUpdateDetailsParameters, $companyID = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BrandID', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
