...
class CompanyApi
{
     ...
     * @param \Swagger\Client\Model\CreateCompanyUserRole $createCompanyUserRole Company&#39;s User Priveleges Parameters for the company ID and userID. (optional)
     * @return \Swagger\Client\Model\UserID
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function addUserCompany($id, $brandID = null, $storeID = null, $productID = null, $couponID = null, $createCompanyUserRole = null)
    {
        list($response) = $this->addUserCompanyWithHttpInfo($id, $brandID, $storeID, $productID, $couponID, $createCompanyUserRole);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function addUserCompanyWithHttpInfo($id, $brandID = null, $storeID = null, $productID = null, $couponID = null, $createCompanyUserRole = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($createCompanyUserRole)) {
            $_tempBody = $createCompanyUserRole;
        }
     ...
     * 
     *
     * @param string $name Optional filter parameter to search for companies with a name that contains value of parameter name. (optional)
     * @param string $inChargePersonName Optional filter parameter to search for companies with inChargePersonName that contains value of parameter inChargePersonName. (optional)
     * @param string $mainAddress Optional filter parameter to search for companies with mainAddress that contains value of parameter mainAddress. (optional)
     * @param string $companyType Optional filter parameter to search for companies with companyType that contains value of parameter companyType. (optional)
     * @return \Swagger\Client\Model\CompaniesArray
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function allCompanies($name = null, $inChargePersonName = null, $mainAddress = null, $companyType = null)
    {
        list($response) = $this->allCompaniesWithHttpInfo($name, $inChargePersonName, $mainAddress, $companyType);
        return $response;
    }

    /**
     * Operation allCompaniesWithHttpInfo
     *
     * 
     *
     * @param string $name Optional filter parameter to search for companies with a name that contains value of parameter name. (optional)
     ...
     * @param string $mainAddress Optional filter parameter to search for companies with mainAddress that contains value of parameter mainAddress. (optional)
     * @param string $companyType Optional filter parameter to search for companies with companyType that contains value of parameter companyType. (optional)
     * @return Array of \Swagger\Client\Model\CompaniesArray, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function allCompaniesWithHttpInfo($name = null, $inChargePersonName = null, $mainAddress = null, $companyType = null)
    {
        // parse inputs
        $resourcePath = "/company/all";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // query params
        if ($inChargePersonName !== null) {
            $queryParams['inChargePersonName'] = $this->apiClient->getSerializer()->toQueryValue($inChargePersonName);
        }
        // query params
        if ($mainAddress !== null) {
            $queryParams['mainAddress'] = $this->apiClient->getSerializer()->toQueryValue($mainAddress);
        }
        // query params
        if ($companyType !== null) {
            $queryParams['companyType'] = $this->apiClient->getSerializer()->toQueryValue($companyType);
        }
        // default format to json
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\CompaniesArray',
                '/company/all'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CompaniesArray', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CompaniesArray', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
     ...
     * 
     *
     * @param string $id ID for the company to be deleted. (required)
     * @return \Swagger\Client\Model\Success
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function companyDelete($id)
    {
        list($response) = $this->companyDeleteWithHttpInfo($id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function companyDeleteWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling companyDelete');
        }
        // parse inputs
        $resourcePath = "/company/{id}/delete";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     *
     * @param string $id ID for the Company (required)
     * @param \Swagger\Client\Model\DeleteCompanyUserRole $deleteCompanyUserRole Company&#39;s User ID and privileges to be removed for the company ID. (required)
     * @param string $brandID ID of the Brand connected with the Company (only required for Authorization for the User making the request) (optional)
     * @param string $storeID ID of the Store connected with the Company (only required for Authorization for the User making the request) (optional)
     * @param string $productID ID of the Product connected with the Company (only required for Authorization for the User making the request) (optional)
     * @param string $couponID ID of the Coupon connected with the Company (only required for Authorization for the User making the request) (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function removeUserCompany($id, $deleteCompanyUserRole, $brandID = null, $storeID = null, $productID = null, $couponID = null)
    {
        list($response) = $this->removeUserCompanyWithHttpInfo($id, $deleteCompanyUserRole, $brandID, $storeID, $productID, $couponID);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function removeUserCompanyWithHttpInfo($id, $deleteCompanyUserRole, $brandID = null, $storeID = null, $productID = null, $couponID = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling removeUserCompany');
        }
        // verify the required parameter 'deleteCompanyUserRole' is set
        if ($deleteCompanyUserRole === null) {
            throw new \InvalidArgumentException('Missing the required parameter $deleteCompanyUserRole when calling removeUserCompany');
        }
        // parse inputs
        $resourcePath = "/company/{id}/user";
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($deleteCompanyUserRole)) {
            $_tempBody = $deleteCompanyUserRole;
        }
