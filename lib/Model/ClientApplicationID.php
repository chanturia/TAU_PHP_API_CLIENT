...
/**
 * ClientApplicationID Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ClientApplicationID implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ClientApplicationID';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['clientAppID'] === null) {
            $invalid_properties[] = "'clientAppID' can't be null";
        }
