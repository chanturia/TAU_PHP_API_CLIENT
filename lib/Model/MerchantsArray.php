...
/**
 * MerchantsArray Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MerchantsArray implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'MerchantsArray';
    ...
    protected static $swaggerTypes = array(
        'merchants' => '\Swagger\Client\Model\Merchant[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['merchants'] === null) {
            $invalid_properties[] = "'merchants' can't be null";
        }
    ...
    /**
     * Sets merchants
     * @param \Swagger\Client\Model\Merchant[] $merchants
     * @return $this
     */
