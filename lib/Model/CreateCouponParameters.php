...
class CreateCouponParameters implements ArrayAccess
{
    ...
    /**
     * Sets categories
     * @param string[] $categories contain array with elements the category ids that the coupon will be connected with
     * @return $this
     */
    ...
    /**
     * Sets selectedStores
     * @param string[] $selectedStores a free form user defined object that includes a key - value array. Place your custom properties in array, the key corresponds to property name its length must be not longer that 40 chars and value for each custom key is limited to 2048 chars.
     * @return $this
     */
