...
/**
 * CouponsArray Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CouponsArray implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CouponsArray';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['coupons'] === null) {
            $invalid_properties[] = "'coupons' can't be null";
        }
